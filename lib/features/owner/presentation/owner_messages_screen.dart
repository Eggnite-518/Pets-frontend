...
import '../../caretaker/domain/entities/conversation.dart';
import '../../caretaker/domain/usecases/get_conversations_use_case.dart';
...
class _OwnerMessagesScreenState extends State<OwnerMessagesScreen> {
  ...
  void _openChat(Conversation conversation) {
    final query = {
      ...
      if (conversation.peerId.isNotEmpty) 'peerId': conversation.peerId,
